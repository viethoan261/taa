			...
			<div class="span9">
				...
				<div class="well well-small">
					<div class="row-fluid">
							...
							<div id="myCarousel" class="carousel slide cntr">
								<div class="carousel-inner">
									<div class="item active">
										<a href="#"> <img src="<c:url value='/template/user/assets/img/a.jpg'/>" alt="" style="width:100%"></a>
									</div>
									<div class="item">
						...
						<div class="span7">
							...
							<form class="form-horizontal qtyFrm" method="get" action="<c:url value="/AddCart/${product.id}"/>">
								...
								<p>${product.title}<p>
									<button type="submit" class="shopBtn"><span class=" icon-shopping-cart" title="Add to cart"></span>Thêm vào giỏ hàng</button>
							</form>
						</div>
					</div>
					<hr class="softn clr" />
					...
					<ul id="productDetail" class="nav nav-tabs">
						<li class="active"><a href="#home" data-toggle="tab" title="Product Details">Thông Tin Chi Tiết Sản Phẩm</a></li>
						<li class=""><a href="#profile" data-toggle="tab" title="Related Products">Sản Phẩm Liên Quan</a></li>
						<li class="dropdown">
