				...
				<ul class="nav nav-list promowrapper">
					<li>
						<div class="thumbnail">
							...
							<img src="<c:url value='template/admin/assets/img/bootstrap-ecommerce-templates.png'/>" alt="bootstrap ecommerce templates">
							<div class="caption">
					...
					<div id="myCarousel" class="carousel slide homCar">
						<div class="carousel-inner">
							<div class="item">
								...
								<img style="width:100%" src="<c:url value='template/admin/assets/img/bootstrap_free-ecommerce.png'/>" alt="bootstrap ecommerce templates">
							...
							<div class="item">
								...
								<img style="width:100%" src="<c:url value='template/admin/assets/img/carousel1.png'/>" alt="bootstrap ecommerce templates">
								<div class="carousel-caption">
							...
							<div class="item active">
								...
								<img style="width:100%" src="<c:url value='template/admin/assets/img/carousel3.png'/>" alt="bootstrap ecommerce templates">
								<div class="carousel-caption">
							...
							<div class="item">
								...
								<img style="width:100%" src="<c:url value='template/admin/assets/img/bootstrap-templates.png'/>" alt="bootstrap templates">
								<div class="carousel-caption">
									...
									<ul class="thumbnails">
										<li class="span3">
											<div class="thumbnail">
												...
												<a href="product_details.html"><img src="<c:url value='template/admin/assets/img/bootstrap-ring.png'/>" alt="bootstrap-ring"></a>
											</div>
										</li>
										<li class="span3">
											<div class="thumbnail">
												...
												<a href="product_details.html"><img src="<c:url value='template/admin/assets/img/i.jpg'/>" alt=""></a>
											</div>
										</li>
										<li class="span3">
											<div class="thumbnail">
												...
												<a href="product_details.html"><img src="<c:url value='template/admin/assets/img/g.jpg'/>" alt=""></a>
											</div>
										</li>
										<li class="span3">
											<div class="thumbnail">
												...
												<a href="product_details.html"><img src="<c:url value='template/admin/assets/img/s.png'/>" alt=""></a>
											</div>
										</li>
									</ul>
								</div>
									...
									<ul class="thumbnails">
										...
										<li class="span3">
											<div class="thumbnail">
												...
												<a href="product_details.html"><img src="<c:url value='template/admin/assets/img/f.jpg'/>" alt=""></a>
											</div>
										</li>
										<li class="span3">
											<div class="thumbnail">
												...
												<a href="product_details.html"><img src="<c:url value='template/admin/assets/img/h.jpg'/>" alt=""></a>
											</div>
										</li>
										<li class="span3">
											<div class="thumbnail">
												...
												<a href="product_details.html"><img src="<c:url value='template/admin/assets/img/j.jpg'/>" alt=""></a>
											</div>
										</li>
									</ul>
								</div>
						...
						<ul class="thumbnails">
							<li class="span4">
								<div class="thumbnail">
									...
									<a href="product_details.html"><img src="<c:url value='template/admin/assets/img/b.jpg'/>" alt=""></a>
